...
import SocialLogin from "../User/Shared/SocialLogin/SocialLogin";
...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Campus Explorer</title>
      </Helmet>
      <div
        className="hero min-h-screen"
        style={{
          backgroundImage: `url('https://i.ibb.co/YTYmKXG/log.png')`,
        }}
      >

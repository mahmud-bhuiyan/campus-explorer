...
const PromotionCard = () => {
  return (
    <div className="bg-[#F36B3B] lg:flex justify-between items-center gap-10 px-10 py-3 text-white">
      ...
      <a
        href="#_"
        className="inline-flex items-center justify-center h-10 px-6 py-0 text-md font-semibold text-center text-gray-200 no-underline align-middle transition-all duration-300 ease-in-out bg-transparent border-2 border-gray-600 border-solid rounded-full cursor-pointer select-none hover:text-white hover:border-white focus:shadow-xs focus:no-underline"
      >
        Book Courses
      </a>
    </div>
